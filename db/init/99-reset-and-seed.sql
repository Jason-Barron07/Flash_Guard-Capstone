...
INSERT INTO dbo.transactions (
	id, sender_account_id, recipient_account_id, transaction_type, service_type, service_network, service_phone_number, amount, status, created_at, authorized_at, settled_at, compliance_flag
)
VALUES
	(1, 1, 2, 'transfer', NULL, NULL, NULL, 250.00, 'completed', DATEADD(MINUTE, -30, SYSUTCDATETIME()), DATEADD(MINUTE, -29, SYSUTCDATETIME()), DATEADD(MINUTE, -28, SYSUTCDATETIME()), NULL),
	(2, 1, 2, 'transfer', NULL, NULL, NULL, 100.00, 'pending', DATEADD(MINUTE, -10, SYSUTCDATETIME()), NULL, NULL, NULL),
	(3, 1, 3, 'transfer', NULL, NULL, NULL, 15000.00, 'rejected', DATEADD(MINUTE, -5, SYSUTCDATETIME()), NULL, NULL, 'aml'),
	(4, 2, 1, 'transfer', NULL, NULL, NULL, 5000.00, 'pending', DATEADD(MINUTE, -2, SYSUTCDATETIME()), NULL, NULL, NULL);
